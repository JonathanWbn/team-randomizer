...
export const GroupButton = ({
  ...
  return (
    <motion.button
      className="relative w-24 rounded-lg bg-gradient-to-br from-[#007CF0] to-[#00DFD8] text-[#0087b6] shadow shadow-[#0087b6]/40 outline-none transition-all hover:shadow-md hover:shadow-[#0087b6]/40"
